  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Button variant="ghost" onClick={fetchCategories} size="sm">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">{cat.skillCount} skills · ID: {cat.id}</p>
                      </div>
                    </div>
                    ...
                    >
                      {isUpdating ? (
                        <div className="h-6 w-6 border-2 border-primary/50 border-t-transparent rounded-full animate-spin" />
                      ) : cat.is_active ? (
