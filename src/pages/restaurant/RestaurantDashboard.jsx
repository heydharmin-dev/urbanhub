...
export default function RestaurantDashboard() {
  ...
  const statCards = [
    ...
    { label: 'Filled', value: stats.filled, icon: CheckCircle, color: 'text-emerald-600 bg-emerald-50' },
  ]
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your service requests and find the right provider</p>
        </div>
        <Button asChild>
          <Link to="/restaurant/post-job" className="flex items-center gap-2">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link to="/restaurant/my-jobs" className="text-primary hover:text-primary/80 text-sm font-medium">
            View All &rarr;
          </Link>
        </div>
        ...
        {recentJobs.length === 0 ? (
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-1">No requests posted yet</h3>
              <p className="text-muted-foreground mb-4">Post your first request to find the perfect service provider</p>
              <Button asChild>
                <Link to="/restaurant/post-job" className="inline-flex items-center gap-2">
